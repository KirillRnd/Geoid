$(document).ready(function() {
	$('.open').bind('click', function(){
			$( ".slide_panel_wrap" ).slideToggle( "slow", function() {
	...
	for(var key in data) {
		obj=data[key];
			...
			var $info = $("<div>").addClass("info")
				...
				.append($("<p>").text("Email: " + obj.Email))
				.append($("<p>").text("Расстояние: " + Math.round(obj.distance)+"км"))
				.append($("<p>").text("Погода: " + obj.Rain))
				.append($("<p>").text("Температура: " + obj.Temp))
				.append($("<p>").text("Давление: " + obj.Pres))
				.append($("<p>").text("WebSite: " + obj.WebSite));
